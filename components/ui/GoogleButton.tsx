...
export default function GoogleButton({ role, label = "Continuer avec Google", className = "", tmRef }: GoogleButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className={`w-full flex items-center justify-center gap-3 py-3.5 rounded-xl font-semibold text-[#1f1f1f] bg-white border border-white/90 hover:bg-gray-50 hover:shadow-md transition-all font-dm ${className}`}
    >
