      ...
      {user?.status === "suspended" && (
        <div className="mb-5 rounded-2xl border border-red-500/30 bg-red-500/5 overflow-hidden">
          <div className="bg-red-500/10 px-5 py-3 flex items-center gap-2.5 border-b border-red-500/20">
            ...
            <h3 className="font-bold text-red-400">Compte suspendu</h3>
          </div>
          <div className="p-5">
            <p className="text-sm text-white/60 mb-4">
              Ton compte a &eacute;t&eacute; suspendu en raison d&apos;activit&eacute;s d&eacute;tect&eacute;es comme non conformes.
              Pendant cette p&eacute;riode, tu ne peux plus gagner de revenus sur les campagnes.
            </p>

            {clickStats && (
              <div className="rounded-xl bg-white/5 p-4 mb-4">
                <p className="text-xs text-white/40 font-semibold uppercase tracking-wider mb-3">Qualit&eacute; de tes clics</p>
                <div className="grid grid-cols-3 gap-3 mb-3">
                  <div className="text-center">
                    <span className="text-lg font-black block">{clickStats.total}</span>
                    <span className="text-[9px] text-white/40">Total clics</span>
                  </div>
                  <div className="text-center">
                    <span className="text-lg font-black text-emerald-400 block">{clickStats.valid}</span>
                    <span className="text-[9px] text-white/40">Valides</span>
                  </div>
                  <div className="text-center">
                    <span className="text-lg font-black text-red-400 block">{clickStats.invalid}</span>
                    <span className="text-[9px] text-white/40">Invalides</span>
                  </div>
                </div>
                ...
                <p className="text-xs text-white/30 mt-1.5 text-right">
                  Taux de validit&eacute; : <span className={`font-bold ${
            ...
            <p className="text-xs text-white/40 mb-4">
              Si tu penses qu&apos;il s&apos;agit d&apos;une erreur, contacte notre &eacute;quipe support pour en discuter.
            </p>

            <button
              onClick={() => window.open("https://wa.me/221781362728?text=Bonjour%2C%20mon%20compte%20%C3%A9cho%20a%20%C3%A9t%C3%A9%20suspendu.%20Pouvez-vous%20m%27aider%20%3F", "_blank")}
