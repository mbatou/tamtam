...
export default function RythmesPage() {
  ...
  async function handleSmartShare(shortCode: string, campaignId: string, creativeUrls?: string[], campaignObjective?: string) {
    ...
    // For awareness campaigns, image is mandatory — don't fall back to link-only
                ...
                {isAccepted && myLink ? (
                  <div>
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        onClick={() => isShareable ? handleSmartShare(myLink.short_code, campaign.id, campaign.creative_urls, campaign.objective) : openDetail(campaign)}
            ...
            {canAskNotification() && (
              <div className="bg-card rounded-xl p-6 text-center">
                ...
                <p className="text-gray-400 text-sm mb-4">
                  {t("echo.rythmes.notifFirstToShare")}
                </p>
                <button
                  onClick={async () => {
