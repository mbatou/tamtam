  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      <div className="mt-12 border-t border-red-500/20 pt-8">
        <h3 className="text-red-400 font-bold text-lg mb-2">{t("admin.settings.dangerZone")}</h3>
        <p className="text-white/30 text-sm mb-4">
          {t("admin.settings.deleteDescription")}
        </p>
        <button
          onClick={() => setShowDeleteModal(true)}
          className="bg-red-500/10 border border-red-500/30 text-red-400 px-6 py-2.5 rounded-xl text-sm hover:bg-red-500/20 transition"
        >
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-red-500/30 rounded-xl p-6 max-w-md w-full">
            <h3 className="text-red-400 font-bold text-lg mb-2">{t("admin.settings.deleteConfirm")}</h3>
            <p className="text-white/40 text-sm mb-4">
              {t("admin.settings.deleteIrreversible")}
            </p>
            ...
            <div className="mb-4">
              <label className="text-white/30 text-xs mb-1 block">
                {t("admin.settings.typeToConfirm")}
              </label>
              <input
                type="text"
