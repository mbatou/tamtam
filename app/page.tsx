  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <input
          type="email"
          placeholder={t("landing.proEmail")}
          required
          value={form.email}
        ...
        <input
          type="tel"
          placeholder={t("landing.whatsappOptional")}
          value={form.whatsapp}
      ...
      <section className="px-4 sm:px-6 py-14 sm:py-20 max-w-7xl mx-auto">
        <div className="glass-card p-6 sm:p-10 md:p-16 animate-pulse-glow">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center">
            {[
              { value: 12500, suffix: "+", label: t("landing.activeEchos") },
              { value: 340, suffix: "", label: t("landing.launchedRythmes") },
              { value: 2800000, suffix: "", label: t("landing.resonances") },
              { value: 45000000, suffix: "", label: t("landing.distributedFCFA") },
            ].map((stat) => (
              <div key={stat.label}>
      ...
      <section id="pour-les-marques" className="px-4 sm:px-6 py-14 sm:py-20 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-start">
          ...
          <div className="glass-card p-6 sm:p-8 border border-secondary/20" style={{ boxShadow: "0 0 40px rgba(26,188,156,0.06)" }}>
            <h3 className="text-lg sm:text-xl font-bold mb-2">{t("landing.getBatteurAccess")}</h3>
            <p className="text-xs text-white/40 mb-5">{t("landing.getBatteurDesc")}</p>
            <BrandLeadForm />
          ...
          <div className="glass-card p-6 sm:p-8 hover-lift">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-sm font-semibold">{t("landing.campaignDemo")}</span>
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  ...
                  <p className="text-[10px] text-white/40">{t("landing.resonances")}</p>
                </div>
                <div>
                  <p className="text-xl sm:text-2xl font-black">156</p>
                  <p className="text-[10px] text-white/40">{t("landing.echos")}</p>
                </div>
                <div>
                  <p className="text-xl sm:text-2xl font-black gradient-text">25 FCFA</p>
                  <p className="text-[10px] text-white/40">{t("landing.cpc")}</p>
                </div>
              </div>
            </div>
            <div className="mt-6 pt-4 border-t border-white/5">
              <p className="text-xs text-white/30 mb-3">{t("landing.whyBrandsChoose")}</p>
              <div className="space-y-2">
                {[t("landing.measurableResults"), t("landing.budgetFrom"), t("landing.dedicatedSupport")].map((item) => (
      ...
      <section className="px-4 sm:px-6 py-14 sm:py-20 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="glass-card p-8 sm:p-10 text-center bg-gradient-to-br from-secondary/10 to-secondary/5">
            ...
            <h2 className="text-xl sm:text-2xl font-bold mb-3 tracking-tight">
              {t("landing.boostVisibility")}
            </h2>
            <p className="text-white/40 mb-6 text-sm max-w-sm mx-auto">
              {t("landing.boostVisibilityDesc")}
            </p>
